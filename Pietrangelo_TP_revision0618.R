...
OTU_97_microbial_reads_proportion
...
design_info_2$Description <- ordered(design_info_2$Description, levels=c("waterP", "waterhizoP", "biofilmP", "waterT", "waterhizoT", "biofilmT", "control")) 
design_info_2$Description                                                                      

#Figure S1A
with(design_info_2, boxplot(Microbial_OTUs_reads ~ Description, xlab = "Samples", ylab = "%  sequencing reads",   main = "Reads assigned to Microbial OTUs"))

#Figure S1B
with(design_info_2, boxplot(reads ~ Description, xlab = "Samples", ylab = " sequencing reads",   main = "Reads assigned to Microbial OTUs"))

#we need to calculate the max, min and mean number of reads for the dataset
